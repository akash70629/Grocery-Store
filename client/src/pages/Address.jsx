  ...
  return (
    <div className=''>
        <div className='bg-white shadow-lg px-2 py-2 flex justify-between gap-4 items-center '>
            ...
            <button onClick={()=>setOpenAddress(true)} className='border border-primary-200 text-black px-3 hover:bg-primary-200 hover:text-black py-1 rounded-full font-normal'>
                Add Address
            </button>
        </div>
        <div className='bg-blue-50 p-2 grid gap-4'>
              ...
              <div onClick={()=>setOpenAddress(true)} className='h-16 bg-blue-50 border-2 border-dashed flex justify-center items-center cursor-pointer font-normal hover:bg-blue-200'>
                Add address
              </div>
        </div>
