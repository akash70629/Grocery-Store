  ...
  return (
    <section className='container mx-auto p-4 grid lg:grid-cols-2 '>
        ...
        <div className='p-4 lg:pl-7 text-base lg:text-lg'>
            ...
            <br /> 
            <p className='font-light'>{data.unit}</p> 
            <Divider/>
            <div>
              ...
              <div className='flex items-center gap-2 lg:gap-4'>
                ...
                {
                  data.discount && (
                    <p className='line-through font-light'>{DisplayPriceInRupees(data.price)}</p>
                  )
                }
                {
                  data.discount && (
            ...
            <div>
                  <div className='flex  items-center gap-4 my-4'>
                      ...
                      <div className='text-sm'>
                        ...
                        <p className='font-light'>Get your orer delivered to your doorstep at the earliest from dark stores near you.</p>
                      </div>
                  </div>
                  <div className='flex  items-center gap-4 my-4'>
                      <img
                      ...
                      <div className='text-sm'>
                        ...
                        <p className='font-light'>Best price destination with offers directly from the nanufacturers.</p>
                      </div>
                  </div>
                  <div className='flex  items-center gap-4 my-4'>
                      <img
                      ...
                      <div className='text-sm'>
                        ...
                        <p className='font-light'>Choose from 5000+ products across food personal care, household & other categories.</p>
                      </div>
                  </div>
            </div>
