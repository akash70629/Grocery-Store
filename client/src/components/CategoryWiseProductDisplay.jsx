...
const CategoryWiseProductDisplay = ({ id, name }) => {
  ...
  const redirectURL =  handleRedirectProductListpage()
    return (
        <div>
            <div className='container mx-auto p-4 flex items-center justify-between gap-4 font-light'>
                <h3 className='font-semibold text-lg md:text-xl'>{name}</h3>
                <Link  to={redirectURL} className='text-black hover:text-green-600 hover:font-bold'>See All</Link>
            </div>
