...
const CardProduct = ({data}) => {
  ...
  return (
    <Link to={url} className='border py-2 lg:p-4 grid gap-1 lg:gap-3 min-w-36 lg:min-w-52 rounded cursor-pointer bg-white' >
      ...
      <div className='flex items-center gap-1 font-light text-xs lg:text-sm px-2 lg:px-0'>
      ...
      <div className='w-fit gap-1 px-2 lg:px-0 text-sm lg:text-base font-light'>
        {data.unit} 
